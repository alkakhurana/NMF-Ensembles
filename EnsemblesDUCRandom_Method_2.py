...
##over the range [k, 2k] where k is generated according to formula
## proposed in   (Aliguliyev,  2009).
...
def generateBaseModels(A,k):
    ...
    lower_limit = k
    upper_limit = 2*k
    if(upper_limit > no_of_sentences):
        upper_limit = no_of_sentences
...
for f in os.listdir(".\\Documents"):
    ...
    ensemble_size = upper_limit - lower_limit + 1
